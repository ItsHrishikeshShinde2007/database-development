CREATE DATABASE IF NOT EXISTS F1_driver_management;

USE F1_driver_management;
...
ALTER TABLE drivers
MODIFY COLUMN team VARCHAR(200);

DELETE FROM drivers
WHERE driver_number = 11;

SELECT
    team,
    COUNT(*) AS num_drivers,
    MAX(championships) AS max_champs
FROM drivers
GROUP BY team;
...
INSERT INTO drivers (driver_number, name, team)
VALUES (99, 'Temp Driver', 'Test Team');
...
INSERT INTO drivers (driver_number, name, team)
VALUES (100, 'Committed Driver', 'Test Team');
